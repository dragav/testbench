...
namespace CertExplorerNetStd
{
    public sealed class CertExplorer
    {
        ...
        public static List<Tuple<string, string>> ListCertificates()
        {
            ...
            {
                store.Open(OpenFlags.IncludeArchived | OpenFlags.MaxAllowed | OpenFlags.OpenExistingOnly);
        ...
        internal static RSACryptoServiceProvider CloneCSP(RSACryptoServiceProvider cspKey)
        {
            CspParameters cspParams = new CspParameters
            {
            ...
            if (cspKey.CspKeyContainerInfo.MachineKeyStore) cspParams.Flags |= CspProviderFlags.UseMachineKeyStore;
